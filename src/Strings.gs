...
var Strings = (function () {
  ...
  T.en = {
    ...
    uiLanguageLabel: 'Sidebar and menu language', uiAuto: 'Auto: {language} (your account language)',
    uiReload: 'Reopen the sidebar to see it. The menu follows after you reload the page.',
  ...
  T.ms = {
    ...
    uiLanguageLabel: 'Bahasa bar sisi dan menu', uiAuto: 'Auto: {language} (bahasa akaun anda)',
    uiReload: 'Buka semula bar sisi untuk melihatnya. Menu akan berubah selepas halaman dimuat semula.',
  ...
  T.id = {
    ...
    uiLanguageLabel: 'Bahasa sidebar dan menu', uiAuto: 'Otomatis: {language} (bahasa akun Anda)',
    uiReload: 'Buka kembali sidebar untuk melihatnya. Menu berubah setelah halaman dimuat ulang.',
  ...
  T.es = {
    ...
    uiLanguageLabel: 'Idioma de la barra lateral y del menú', uiAuto: 'Automático: {language} (idioma de tu cuenta)',
    uiReload: 'Vuelve a abrir la barra lateral para verlo. El menú cambia al recargar la página.',
  ...
  T.fr = {
    ...
    uiLanguageLabel: 'Langue de la barre latérale et du menu', uiAuto: 'Auto : {language} (langue de votre compte)',
    uiReload: 'Rouvrez la barre latérale pour le voir. Le menu change après rechargement de la page.',
  ...
  T.de = {
    ...
    uiLanguageLabel: 'Sprache von Seitenleiste und Menü', uiAuto: 'Automatisch: {language} (Sprache Ihres Kontos)',
    uiReload: 'Seitenleiste neu öffnen, um es zu sehen. Das Menü folgt nach dem Neuladen der Seite.',
  ...
  T.pt = {
    ...
    uiLanguageLabel: 'Idioma da barra lateral e do menu', uiAuto: 'Automático: {language} (idioma da sua conta)',
    uiReload: 'Reabra a barra lateral para ver. O menu muda depois de recarregar a página.',
  ...
  T.it = {
    ...
    uiLanguageLabel: 'Lingua della barra laterale e del menu', uiAuto: 'Automatica: {language} (lingua del tuo account)',
    uiReload: 'Riapri la barra laterale per vederla. Il menu cambia dopo aver ricaricato la pagina.',
  ...
  T.nl = {
    ...
    uiLanguageLabel: 'Taal van zijbalk en menu', uiAuto: 'Automatisch: {language} (taal van je account)',
    uiReload: 'Open de zijbalk opnieuw om het te zien. Het menu volgt na het herladen van de pagina.',
  ...
  T.tl = {
    ...
    uiLanguageLabel: 'Wika ng sidebar at menu', uiAuto: 'Auto: {language} (wika ng iyong account)',
    uiReload: 'Buksan muli ang sidebar para makita. Magbabago ang menu matapos i-reload ang page.',
  ...
  T.tr = {
    ...
    uiLanguageLabel: 'Kenar çubuğu ve menü dili', uiAuto: 'Otomatik: {language} (hesap diliniz)',
    uiReload: 'Görmek için kenar çubuğunu yeniden açın. Menü, sayfa yenilenince değişir.',
  ...
  T.el = {
    ...
    uiLanguageLabel: 'Γλώσσα πλαϊνής γραμμής και μενού', uiAuto: 'Αυτόματα: {language} (γλώσσα του λογαριασμού σας)',
    uiReload: 'Ανοίξτε ξανά την πλαϊνή γραμμή για να το δείτε. Το μενού αλλάζει μετά την επαναφόρτωση της σελίδας.',
