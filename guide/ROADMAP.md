...
## 1.1 (built and tested 15 September 2026, release after the 1.0.1 review)
...
## 1.3
- **Language picker** (Auto from the account language, English, Bahasa Malaysia, Bahasa Indonesia, Spanish, French, German, Portuguese, Italian, Dutch, Tagalog) driving the Title Case small words and the English-only "i" pronoun rule.
- Locale-correct lowercase for Greek (final sigma) and Turkish (dotted and dotless i).
